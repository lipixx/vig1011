...
void
Model::make_face (char **words, int nwords, int currentMaterial)
{
  Face face;
...
void
read_mtllib (char **words, int nwords, MaterialLib & matlib,
...
void
Model::readObj (const char *filename, MaterialLib & matlib)
{
